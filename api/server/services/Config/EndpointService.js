...
module.exports = {
  config: {
    ...
    [EModelEndpoint.closeAI]: generateConfig(openAIApiKey, OPENAI_REVERSE_PROXY), // CloseAI uses same config as OpenAI for now
    ...
    /* Analytics endpoint - always enabled, uses OpenAI API key for SQL generation */
    [EModelEndpoint.analytics]: generateConfig('true', undefined, EModelEndpoint.analytics),
  },
};
