...
const tokenValues = Object.assign(
  {
    ...
    // OpenRouter Google models (Pro/Ultra only)
    'google/gemini-3-pro-preview': { prompt: 5, completion: 20 },
    // OpenRouter MoonshotAI models (Pro/Ultra only)
    'moonshotai/kimi-k2.5': { prompt: 2, completion: 8 },
...
const cacheTokenValues = {
  ...
  // OpenRouter Claude models
  'anthropic/claude-sonnet-4.5': { write: 3.75, read: 0.3 },
  'anthropic/claude-opus-4.5': { write: 6.25, read: 0.5 },
  // OpenRouter Google models (Pro/Ultra only)
  'google/gemini-3-pro-preview': { write: 1.25, read: 0.625 },
  // OpenRouter MoonshotAI models (Pro/Ultra only)
  'moonshotai/kimi-k2.5': { write: 2, read: 0.5 },
