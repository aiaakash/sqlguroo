...
export const getDisplayValue = ({
  ...
  if (selectedValues.model && selectedValues.endpoint) {
    ...
    // Handle closeAI and analytics endpoints with connection names
    if (
      (endpoint.value === EModelEndpoint.closeAI || endpoint.value === EModelEndpoint.analytics) &&
      endpoint.connectionNames &&
      endpoint.connectionNames[selectedValues.model]
    ) {
      return endpoint.connectionNames[selectedValues.model];
    }
