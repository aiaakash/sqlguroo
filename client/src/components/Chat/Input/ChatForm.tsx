...
import SavedQueriesMention from './SavedQueriesMention';
import AnalyticsModelSelector from './AnalyticsModelSelector';
...
const ChatForm = memo(({ index = 0 }: { index?: number }) => {
  ...
  const [showSavedQueriesPopover, setShowSavedQueriesPopover] = useRecoilState(
    store.showSavedQueriesPopoverFamily(index),
  );
        ...
        <div className={cn('flex w-full items-center', isRTL && 'flex-row-reverse')}>
          ...
          <SavedQueriesMention
            ...
            onSelectQuery={(query) => {
              ...
              // Replace the last @ character with the query reference
              const newText = currentText.replace(/@$/, `[Saved: ${query.name}]\n\n${query.sqlContent}\n\n`);
          ...
          >
            ...
            >
              <div className={`${isRTL ? 'mr-2' : 'ml-2'} flex items-end`}>
