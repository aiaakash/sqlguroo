...
export const isAnalyticsEndpoint = (_endpoint?: EModelEndpoint.analytics | null | string): boolean => {
  const endpoint = _endpoint ?? '';
  if (!endpoint) {
    return false;
  }
  return endpoint === EModelEndpoint.analytics;
};
...
export const endpointSettings = {
  ...
  [EModelEndpoint.closeAI]: openAISettings,
