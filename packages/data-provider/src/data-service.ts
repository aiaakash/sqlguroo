...
import * as sub from './types/subscription';
...
export function getAnalyticsConnection(id: string): Promise<analytics.TDatabaseConnection> {
  return request.get(endpoints.analyticsConnection(id));
}

export function createAnalyticsConnection(
  data: analytics.TCreateDatabaseConnectionRequest,
): Promise<analytics.TDatabaseConnection> {
  return request.post(endpoints.analyticsConnections(), data);
}

export function updateAnalyticsConnection(
  id: string,
  data: analytics.TUpdateDatabaseConnectionRequest,
): Promise<analytics.TDatabaseConnection> {
  return request.put(endpoints.analyticsConnection(id), data);
}

export function deleteAnalyticsConnection(id: string): Promise<{ message: string }> {
  return request.delete(endpoints.analyticsConnection(id));
}

/* Skills */
export function getAnalyticsSkills(isActive?: boolean): Promise<analytics.TSkill[]> {
  const params = isActive !== undefined ? `?isActive=${isActive}` : '';
  return request.get(`${endpoints.analyticsSkills()}${params}`);
}

export function getAnalyticsSkill(id: string): Promise<analytics.TSkill> {
  return request.get(endpoints.analyticsSkill(id));
}

export function createAnalyticsSkill(
  data: analytics.TCreateSkillRequest,
): Promise<analytics.TSkill> {
  return request.post(endpoints.analyticsSkills(), data);
}

export function updateAnalyticsSkill(
  id: string,
  data: analytics.TUpdateSkillRequest,
): Promise<analytics.TSkill> {
  return request.put(endpoints.analyticsSkill(id), data);
}

export function deleteAnalyticsSkill(id: string): Promise<{ message: string }> {
...
export function testNewAnalyticsConnection(
  data: analytics.TCreateDatabaseConnectionRequest,
): Promise<analytics.TConnectionTestResult> {
  return request.post(endpoints.analyticsTestNewConnection(), data);
}

export function getAnalyticsConnectionSchema(
  id: string,
  refresh?: boolean,
): Promise<{ schema: analytics.TDatabaseSchema; cachedAt: string }> {
  const url = refresh
    ? `${endpoints.analyticsConnectionSchema(id)}?refresh=true`
    : endpoints.analyticsConnectionSchema(id);
  return request.get(url);
}

export function refreshAnalyticsSchema(
  id: string,
): Promise<{ schema: analytics.TDatabaseSchema; cachedAt: string }> {
...
export function getTableDescriptions(id: string): Promise<{
  ...
  return request.get(endpoints.analyticsTableDescriptions(id));
}

export function saveTableDescriptions(
  id: string,
  data: { tableDescriptions?: Record<string, string>; columnDescriptions?: Record<string, string> },
): Promise<{ success: boolean; message: string }> {
  return request.post(endpoints.analyticsTableDescriptions(id), data);
}

export function sendAnalyticsChat(
  data: analytics.TAnalyticsChatRequest,
): Promise<analytics.TAnalyticsChatResponse> {
  return request.post(endpoints.analyticsChat(), data);
}

export function executeAnalyticsQuery(
  data: analytics.TExecuteQueryRequest,
): Promise<analytics.TExecuteQueryResponse> {
  return request.post(endpoints.analyticsExecuteQuery(), data);
}

export function getAnalyticsHistory(
  conversationId: string,
  limit?: number,
): Promise<analytics.TAnalyticsQuery[]> {
  const url = limit
    ? `${endpoints.analyticsHistory(conversationId)}?limit=${limit}`
    : endpoints.analyticsHistory(conversationId);
  return request.get(url);
}
...
export function getCharts(params?: {
  ...
  pinnedOnly?: boolean;
  search?: string;
}): Promise<charts.ChartsListResponse> {
  return request.get(endpoints.charts(params));
}

export function getChart(chartId: string): Promise<charts.TChart> {
  return request.get(endpoints.chart(chartId));
}

export function getChartWithData(chartId: string): Promise<charts.ChartWithDataResponse> {
  return request.get(endpoints.chartData(chartId));
}

export function getPublicChart(shareId: string): Promise<charts.TChart> {
  return request.get(endpoints.publicChart(shareId));
}

export function createChart(data: charts.CreateChartRequest): Promise<charts.TChart> {
  return request.post(endpoints.charts(), data);
}

export function updateChart(
  chartId: string,
  data: charts.UpdateChartRequest,
): Promise<charts.TChart> {
  return request.put(endpoints.chart(chartId), data);
}

export function updateChartData(
  chartId: string,
  dataSnapshot: charts.TChartDataSnapshot,
): Promise<charts.TChart> {
  return request.put(endpoints.chartData(chartId), { dataSnapshot });
}

export function duplicateChart(chartId: string, name?: string): Promise<charts.TChart> {
  return request.post(endpoints.chartDuplicate(chartId), { name });
}

export function refreshChartData(chartId: string): Promise<charts.ChartWithDataResponse> {
  return request.post(endpoints.chartRefresh(chartId));
}

export function deleteChart(chartId: string): Promise<{ success: boolean }> {
  return request.delete(endpoints.chart(chartId));
}

/* Analytics Query API calls */
export function getAnalyticsQueryByMessageId(
  messageId: string,
): Promise<analytics.TAnalyticsQueryRef> {
  return request.get(endpoints.analyticsQueryByMessageId(messageId));
}

/* Subscription API calls */
export async function getSubscription(): Promise<sub.ISubscriptionResponse> {
  return request.get(endpoints.subscription());
}

export async function getSubscriptionHistory(): Promise<sub.ISubscriptionHistory> {
  return request.get(endpoints.subscriptionHistory());
}

export async function getSubscriptionPlans(): Promise<sub.IPlansResponse> {
  return request.get(endpoints.subscriptionPlans());
}

export async function createCheckout(data: sub.ICheckoutRequest): Promise<sub.ICheckoutResponse> {
  return request.post(endpoints.subscriptionCheckout(), data);
}

export async function cancelSubscription(data?: {
  immediately?: boolean;
}): Promise<{ message: string }> {
  return request.post(endpoints.subscriptionCancel(), data || {});
}

export async function resumeSubscription(): Promise<{ message: string }> {
  return request.post(endpoints.subscriptionResume(), {});
}

export async function changePlan(data: sub.IChangePlanRequest): Promise<{ message: string }> {
  return request.post(endpoints.subscriptionChangePlan(), data);
}

export async function getSubscriptionUsage(): Promise<{ usage: sub.IUsageStats }> {
  return request.get(endpoints.subscriptionUsage());
}

export async function getSubscriptionInvoices(): Promise<sub.IInvoicesResponse> {
  return request.get(endpoints.subscriptionInvoices());
}
...
): Promise<dashboards.DashboardsListResponse> {
  return request.get(endpoints.dashboards(params));
}

export function getSharedDashboards(params?: {
  page?: number;
  pageSize?: number;
}): Promise<dashboards.DashboardsListResponse> {
  return request.get(endpoints.sharedDashboards(params));
}

export function getDashboard(dashboardId: string): Promise<dashboards.TDashboard> {
  return request.get(endpoints.dashboard(dashboardId));
}

export function getDashboardWithCharts(
  dashboardId: string,
): Promise<dashboards.DashboardWithChartsResponse> {
  return request.get(endpoints.dashboardFull(dashboardId));
}

export function getPublicDashboard(
  shareId: string,
): Promise<dashboards.DashboardWithChartsResponse> {
  return request.get(endpoints.publicDashboard(shareId));
}

export function createDashboard(
  data: dashboards.CreateDashboardRequest,
): Promise<dashboards.TDashboard> {
  return request.post(endpoints.dashboards(), data);
}

export function updateDashboard(
  dashboardId: string,
  data: dashboards.UpdateDashboardRequest,
): Promise<dashboards.TDashboard> {
  return request.put(endpoints.dashboard(dashboardId), data);
}

export function updateDashboardLayout(
  dashboardId: string,
  charts: dashboards.IDashboardChartItem[],
): Promise<dashboards.TDashboard> {
  return request.put(endpoints.dashboardLayout(dashboardId), { charts });
}
...
export function addChartToDashboard(
  ...
  return request.post(endpoints.dashboardCharts(dashboardId), chartItem);
}

export function removeChartFromDashboard(
  dashboardId: string,
  chartId: string,
): Promise<dashboards.TDashboard> {
  return request.delete(endpoints.dashboardChart(dashboardId, chartId));
}
...
export function duplicateDashboard(
  ...
  return request.post(endpoints.dashboardDuplicate(dashboardId), { name });
}

export function toggleDashboardStar(dashboardId: string): Promise<dashboards.TDashboard> {
  return request.post(endpoints.dashboardStar(dashboardId), {});
}

export function deleteDashboard(dashboardId: string): Promise<{ success: boolean }> {
  return request.delete(endpoints.dashboard(dashboardId));
}
...
): Promise<admin.TAdminUsersResponse> {
  return request.get(endpoints.adminUsers(params));
}

export function getAdminUser(userId: string): Promise<admin.TAdminUserDetail> {
  return request.get(endpoints.adminUser(userId));
}

export function getAdminStats(): Promise<admin.TAdminStats> {
  return request.get(endpoints.adminStats());
}

export function checkAdminAccess(): Promise<admin.TAdminCheckResponse> {
  return request.get(endpoints.adminCheck());
}

/* Saved Queries API calls */
export function getSavedQueries(
  params?: analytics.TListSavedQueriesParams,
): Promise<analytics.TListSavedQueriesResponse> {
  return request.get(endpoints.savedQueries(params));
}

export function getAllSavedQueries(): Promise<analytics.TSavedQuery[]> {
  return request.get(endpoints.savedQueriesAll());
}

export function getSavedQuery(id: string): Promise<analytics.TSavedQuery> {
  return request.get(endpoints.savedQuery(id));
}

export function createSavedQuery(
  data: analytics.TCreateSavedQueryRequest,
): Promise<analytics.TSavedQuery> {
  return request.post(endpoints.savedQueries(), data);
}

export function updateSavedQuery(
  id: string,
  data: analytics.TUpdateSavedQueryRequest,
): Promise<analytics.TSavedQuery> {
  return request.patch(endpoints.savedQuery(id), data);
}

export function deleteSavedQuery(id: string): Promise<{ message: string }> {
  return request.delete(endpoints.savedQuery(id));
}
