...
const endpointSchemas: Record<EndpointSchemaKey, EndpointSchema> = {
  ...
  [EModelEndpoint.closeAI]: openAISchema,
  ...
  [EModelEndpoint.analytics]: openAISchema,
};
...
export const getResponseSender = (endpointOption: Partial<t.TEndpointOption>): string => {
  ...
  if (
    ...
    return (alternateName[endpoint as keyof typeof alternateName] as string | undefined) ?? 'AI';
  }
