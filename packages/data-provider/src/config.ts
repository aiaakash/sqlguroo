...
// Re-export EModelEndpoint for use in other modules
export { EModelEndpoint, eModelEndpointSchema };
...
export type TStartupConfig = {
  ...
  /** Paddle client token (enterprise only) */
  paddleClientToken?: string;
  /** Paddle environment: 'sandbox' or 'production' (enterprise only) */
...
export const alternateName = {
  ...
  [EModelEndpoint.analytics]: 'Analytics',
...
export enum SettingsTabValues {
  ...
  /**
   * Tab for Analytics Database Connections
   */
  ANALYTICS = 'analytics',
}
...
export const providerEndpointMap = {
  ...
  [EModelEndpoint.closeAI]: EModelEndpoint.openAI, // Maps to Providers.OPENAI since closeAI uses OpenAI-compatible API
