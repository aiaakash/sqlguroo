...
import { createDatabaseConnectionModel } from './databaseConnection';
import { createAnalyticsQueryModel } from './analyticsQuery';
import { createSkillModel } from './skill';
import { createChartModel } from './chart';
import { createDashboardModel } from './dashboard';
...
export function createModels(mongoose: typeof import('mongoose')) {
  return {
    ...
    Chart: createChartModel(mongoose),
    Dashboard: createDashboardModel(mongoose),
